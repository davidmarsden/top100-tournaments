...
export default function ManagerAccountsPage() {
  ...
  return <main className="app-shell">
    <section className="hero"><div className="hero-row"><div><p className="eyebrow">Top 100 Tournament Manager</p><h1>Manager accounts</h1><p>Manage the active Top 100 roster, approve verified-email claims and link managers to their canonical records.</p></div><div className="button-row"><a className="button secondary" href="/admin">Tournament admin</a><a className="button secondary" href="/admin/result-submissions">Result submissions</a><a className="button secondary" href="/admin/soccer-manager-sync">Soccer Manager Sync</a><button type="button" className="secondary" onClick={logout}>Log out</button></div></div></section>
