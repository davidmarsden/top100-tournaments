...
export default function PublicTournamentPage({ tournamentId, routeRows = [] }) {
  ...
  return <main className={`app-shell public-archive tournament-hub${knockoutOnly ? ' knockout-only-hub' : ''}`}>
    ...
    <nav className="public-section-nav" aria-label="Tournament sections">{knockoutOnly ? <><a href="#knockout">Fixtures &amp; Results</a><a href="#summary">Overview</a><a href="#brackets">Bracket</a><a href="#seedings">Seedings</a><a href="#fair-play">Fair Play</a></> : <><a href="#summary">Summary</a><a href="#featured">Featured</a>{showWinners && <a href="#winners">Winners</a>}<a href="#groups">Groups</a><a href="#knockout">Knockout</a><a href="#rankings">Best placed tables</a><a href="#fair-play">Fair Play</a><a href="#seedings">Seedings</a><a href="#brackets">Bracket</a></>}</nav>
