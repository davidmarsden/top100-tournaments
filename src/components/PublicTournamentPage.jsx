...
export default function PublicTournamentPage({ tournamentId, routeRows = [] }) {
  ...
  const heroRemaining = finalReviewPending ? 'Final result under review' : awaitingKnockoutDraw ? (stats.fixtures > 0 ? 'next round pending' : 'draw pending') : `${stats.remaining} fixtures remaining`;
  const heroNextLabel = nextFixture ? countdownText(nextFixture) : finalReviewPending ? 'Final result under review' : awaitingKnockoutDraw ? (stats.fixtures > 0 ? 'Next round draw pending' : 'Draw pending') : 'Complete';
  ...
  return <main className={`app-shell public-archive tournament-hub${knockoutOnly ? ' knockout-only-hub' : ''}`}>
    ...
    <nav className="public-section-nav" aria-label="Tournament sections">{knockoutOnly ? <><a href="#brackets">Bracket</a><a href="#knockout">Fixtures &amp; Results</a><a href="#summary">Overview</a><a href="#seedings">Seedings</a><a href="#fair-play">Fair Play</a></> : <><a href="#summary">Summary</a><a href="#featured">Featured</a>{showWinners && <a href="#winners">Winners</a>}<a href="#groups">Groups</a><a href="#knockout">Knockout</a><a href="#rankings">Best placed tables</a><a href="#fair-play">Fair Play</a><a href="#seedings">Seedings</a><a href="#brackets">Bracket</a></>}</nav>
