const RESOURCES = [
  ...
  { label: 'Community Polls', description: 'See open manager polls, cast your vote and take part in game-world decisions.', href: 'https://vote.smtop100.blog/vote' },
  { label: 'Poll Results', description: 'Read the published results of completed Community Polls.', href: 'https://vote.smtop100.blog/' },
