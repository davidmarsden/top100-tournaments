...
-- Normal-time scores stay in home_score/away_score. FET goals stay in the
-- existing home_extra_time_score/away_extra_time_score columns. The raw match
-- statistics below provide an auditable derivation of those fictional goals.
...
comment on column public.matches.home_extra_time_score is 'Additional fictional-extra-time goals, not the final match score.';
comment on column public.matches.away_extra_time_score is 'Additional fictional-extra-time goals, not the final match score.';
